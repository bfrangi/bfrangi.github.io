...
You are now at a stage where you can make any configurations that you want. For example, you can use `apt` to update sources and install applications.  For example, you can install other Linux kernels.
